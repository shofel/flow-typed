...
type TomatoWithIdT = WithID<TomatoT>

declare var tomato: TomatoT
declare var tomatoWithId: TomatoWithIdT
...
type evolvedExpectedT = $Shape<typeof transformations> | $Shape<TomatoT>

const evolved: evolvedExpectedT  = _.evolve(transformations, tomato)

const objects = [ {}, {}, {} ]
const objectsClone: Array<Object> = _.clone(objects)
const objectsClone1: number = _.clone(1)
const objectsClone2: TomatoT = _.clone(tomato)
//$ExpectError
const objectsClone3: TomatoWithIdT = _.clone(tomato)
const objectsClone4: TomatoWithIdT = _.clone(tomatoWithId)

const id = objectsClone4.id
//$ExpectError
const idE = objectsClone2.id
