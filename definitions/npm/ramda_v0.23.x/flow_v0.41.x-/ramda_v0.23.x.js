...
declare module ramda {
  ...
  */
  ...
  declare function sortBy <T,V>(fn: T => any, ...rest: Array<void>): (Array<T>) => Array<T>;
  declare function sortBy <T,V>(fn: T => any, xs: Array<T>): Array<T>;
  ...
  declare function evolve<T,S>(fns: T, ...rest: Array<void>): (src: S) => ($Shape<T> | $Shape<S>)
  declare function evolve<T,S>(fns: T, src: S): ($Shape<T> | $Shape<S>)
  ...
  */
  ...
  // pathSatisfies
  declare type pred = any => boolean
  declare type propPath = Array<string>

  declare function pathSatisfies(pred, propPath, Object): boolean;
  declare function pathSatisfies(pred, propPath, ...rest: Array<void>): (Object) => boolean;
  declare function pathSatisfies(cond: any => boolean, ...rest: Array<void>):
    ((path: Array<string>, ...rest: Array<void>) => (o: Object) => boolean)
    & ((path: Array<string>, o: Object) => boolean)

  declare function propSatisfies(cond: any => boolean, propName: string, obj: Object): boolean;
  declare function propSatisfies(cond: any => boolean, propName: string, ...rest: Array<void>): (obj: Object) => boolean;
  declare function propSatisfies(cond: any => boolean, ...rest: Array<void>):
    ((propName: string, ...rest: Array<void>) => (obj: Object) => boolean)
    & ((propName: string, o: Object) => boolean)
