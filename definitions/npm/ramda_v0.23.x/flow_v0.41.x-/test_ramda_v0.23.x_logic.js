...
declare var gt10: number => boolean
declare var even: number => boolean
...
// const pathSatisfiesPartial = _.pathSatisfies(y => typeof y === 'number' && y > 0)
// const psat2: boolean = pathSatisfiesPartial([ 'x', 'y' ])({ x: { y: 2 }, z: true })

const pathSatisfiesPartial2 = _.pathSatisfies(y => typeof y === 'number' && y > 0, [ 'x', 'y' ])
const psat3: boolean = pathSatisfiesPartial2({ x: { y: 2 }, z: true })
